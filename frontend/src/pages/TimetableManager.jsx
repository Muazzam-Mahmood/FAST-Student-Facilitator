...
const TimetableManager = ({ user }) => {
  ...
  // Dynamically calculate time slots based on whatever is actually in the timetable
  const timeSlots = Array.from(new Set(timetable.map(t => `${t.startTime}-${t.endTime}`))).sort();
  ...
  const exportAsImage = async () => {
    ...
    // Temporarily make it part of the normal flow so html2canvas renders it properly
  ...
  return (
    <div className="timetable-page">
      ...
      <section className="timetable-viewer">
        ...
        <div id="timetable-weekly-export" style={{ position: 'absolute', left: '-9999px', top: 0, width: '1200px' }}>
